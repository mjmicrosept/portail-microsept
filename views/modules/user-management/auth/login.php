            ...
            <div class="card-group">
                ...
                <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                    <div class="card-body text-center">
                        <div>
                            <img src="/../../images/microsept_logo.png" class="img-circle" style="height:70px" />
                            <br/><br/>
                            <p>Bienvenue sur le portail interne de Microsept. Connectez-vous sur votre profil pour accéder à votre espace de travail.</p>
                            <p>Si vous ne possédez pas de compte, veuillez vous enregistrer.</p>
                            <button class="btn btn-primary active mt-3" type="button">S'enregistrer</button>
                        </div>
                    </div>
                </div>
            </div>
